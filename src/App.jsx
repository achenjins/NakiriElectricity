        ...
        {cells.map((cell, i) => {
          ...
          return (
            <div key={i} className={cn(
              "flex flex-col items-center justify-center p-1 rounded-lg border border-zinc-200 dark:border-zinc-700/50 transition-all",
              ...
              {has ? (<>
                {d.consume > 0 && (
                  <div className="flex items-center gap-1">
                    <span className="text-lg font-bold text-zinc-800 dark:text-zinc-200 leading-tight">-{d.consume} kWh</span>
                    <span className="text-[11px] font-medium text-amber-500 dark:text-amber-400">&yen;{(d.consume * PRICE_PER_KWH).toFixed(1)}</span>
                  </div>
                )}
                {d.recharge > 0 && (
                  <div className="flex items-center gap-1">
